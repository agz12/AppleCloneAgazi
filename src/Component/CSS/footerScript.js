...
//       // $(this).find($("	.footer-links-wrapper h3:after")).removeClass("	.footer-links-wrapper h3:after").addClass(" .footer-links-wrapper .Agazi h3:after");
//     } else {
//       $(".footer-links-wrapper ul").show();
